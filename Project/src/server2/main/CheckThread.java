        ...
        while (true) {
            ...
            if (gameState.getGameState() == GameState.RUNNING) {
                if (socketList.size() < 2) {
                    System.out.println("[寃뚯엫 �룄以� �겢�씪�씠�뼵�듃媛� �굹媛붿뒿�땲�떎. WAITING �긽�깭濡� 蹂�寃쏀빀�땲�떎.]");
                    init();
                    setGameStateWaiting();
                    sendGameState();
                }
    ...
    private void sendCountDown() {
        ...
        for (int i = 3; i >= 0; i--) {
            if (socketList.size() == MAX_CLINET_NUM) {
                ...
                System.out.println("[移댁슫�듃�떎�슫 �룄以� �겢�씪�씠�뼵�듃媛� �굹媛붿뒿�땲�떎. WAITING �긽�깭濡� 蹂�寃쏀빀�땲�떎.]");
                init();
                setGameStateWaiting();
                sendGameState();
                break;
        ...
        while (true) {
            ...
            if (diceNum1 != diceNum2) {
                ...
                try {
                    ...
                    Thread.sleep(2000);
                    if (socketList.size() < 2) {
                        System.out.println("[二쇱궗�쐞 異쒕젰 以� �겢�씪�씠�뼵�듃媛� �굹媛붿뒿�땲�떎. WAITING �긽�깭濡� 蹂�寃쏀빀�땲�떎.]");
                        init();
                        setGameStateWaiting();
                        sendGameState();
                    }
